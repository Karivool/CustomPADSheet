...
const AWAKENINGS = [
  ...
  { value: 'skill-plus', label: <img className='dropdown-img' src='/images/awakenings/56.png' alt='SKILLPLUS'></img>},
  { value: 'skillboost', label: <img className='dropdown-img' src='/images/awakenings/51.png' alt='SKILLBOOST'></img>},
  ...
  { value: 'time-plus', label: <img className='dropdown-img' src='/images/awakenings/53.png' alt='TIMEPLUS'></img>},
  ...
  { value: 'bindres-full', label: <img className='dropdown-img' src='/images/awakenings/52.png' alt='BINDRESFULL'></img>},
  ...
  { value: 'cloud-res', label: <img className='dropdown-img' src='/images/awakenings/54.png' alt='CLOUDRES'></img>},
  { value: 'tape-res', label: <img className='dropdown-img' src='/images/awakenings/55.png' alt='TAPERES'></img>},
  ...
  { value: '10combo', label: <img className='dropdown-img' src='/images/awakenings/61.png' alt='10COMBO'></img>},
  ...
  { value: 'fua2', label: <img className='dropdown-img' src='/images/awakenings/50.png' alt='FUA2'></img>},
  ...
  { value: 'equip', label: <img className='dropdown-img' src='/images/awakenings/49.png' alt='EQUIP'></img>},
  { value: 'atk-plus', label: <img className='dropdown-img' src='/images/awakenings/57.png' alt='ATKPLUS'></img>},
  { value: 'atk-min', label: <img className='dropdown-img' src='/images/awakenings/58.png' alt='ATKMINUS'></img>},
  { value: 'l-shield', label: <img className='dropdown-img' src='/images/awakenings/59.png' alt='LSHIELD'></img>},
  { value: 'l-orb', label: <img className='dropdown-img' src='/images/awakenings/60.png' alt='LORB'></img>},
